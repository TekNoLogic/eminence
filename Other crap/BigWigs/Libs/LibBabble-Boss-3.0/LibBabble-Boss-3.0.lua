...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 178 $"):match("%d+"))
...
elseif GAME_LOCALE == "deDE" then
	...
	["Warder Stilgiss"] = "\009Wärter Stilgiss",
...
elseif GAME_LOCALE == "ruRU" then
	...
	["Death Knight Understudy"] = "Дублер рыцаря Смерти",
...
elseif GAME_LOCALE == "zhTW" then
	...
	Magra = "瑪格拉",
	Magtheridon = "瑪瑟里頓",
	["Maiden of Grief"] = "悲嘆少女", -- Needs review
